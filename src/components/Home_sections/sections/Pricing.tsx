    ...
    <>
      <section className="py-24">
        <div className="container">
          ...
          <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-start lg:justify-center md:flex-row md:items-start md:justify-center md:text-xs">
            {pricingTiers.map(
              ({
                title,
                monthlyPrice,
                  ...
                  <ul className="flex flex-col gap-5 mt-8">
                    {
                      features.map(features => (
                        <li key={features} className="text-sm flex items-center gap-4">
